...
function Box({
  ...
  fill, textColor, subTextColor, stroke,
}: {
  x: number; y: number; label: string; sub?: string;
  color: string; w?: number; h?: number; godot?: boolean;
  fill: string; textColor: string; subTextColor?: string; stroke?: string;
}) {
  ...
  return (
    <g>
      <rect
        ...
        fill={fill} stroke={borderColor} strokeWidth={1.5}
      />
      {godot && (
        <text
      ...
      {sub && (
        <text
          ...
          fill={subColor} fontSize={10} fontFamily="monospace" opacity={0.85}
        >{sub}</text>
      )}
    </g>
  );
...
function DB({
  x, y, label, w = 138, fill, stroke, textColor,
}: {
  x: number; y: number; label: string; w?: number;
  ...
  return (
    <g>
      ...
      <text x={x} y={y + 5} textAnchor="middle"
        fill={textColor} fontSize={9} fontFamily="monospace">{label}</text>
    </g>
  );
}
...
function Badge({
  ...
  x: number; y: number; text: string; color: string; fill: string;
}) {
  ...
  return (
    <g>
      <rect x={x - w / 2} y={y - h / 2} width={w} height={h} rx={9}
        fill={fill} stroke={color} strokeWidth={1} opacity={0.9} />
...
function Arr({
  d, color, id, dashed = false, opacity = 0.72,
}: {
  ...
  return {
    ...
    metropolis: {
      ...
      titleStyle: {
        ...
        textShadow: "0 0 28px rgba(103,232,249,0.45), 0 0 60px rgba(103,232,249,0.2)",
      },
      eyebrowStyle: {
      ...
      bgDecor: (
        <>
          ...
          <div style={{
            ...
            background: "linear-gradient(90deg, transparent, rgba(103,232,249,0.25) 30%, rgba(103,232,249,0.25) 70%, transparent)",
          }} />
        </>
      ),
    },
    ...
    "ice-citadel": {
      ...
      titleStyle: {
        ...
        letterSpacing: "0.1em",
        textTransform: "uppercase",
        textShadow: "0 0 4px rgba(184,230,255,0.8), 0 0 16px rgba(111,195,255,0.6), 0 0 32px rgba(74,144,217,0.5)",
      },
      eyebrowStyle: {
    ...
    tron: {
      ...
      eyebrow: "[ ARCHITECTURE/GRID v.MMXXVI ]",
      title: "SYSTEM_GRID",
      titleStyle: {
        ...
        letterSpacing: "0.1em",
        textTransform: "uppercase",
        textShadow: "0 0 4px rgba(232,254,255,0.9), 0 0 14px rgba(0,240,255,0.8), 0 0 32px rgba(0,240,255,0.5)",
      },
      eyebrowStyle: {
    ...
    netflix: {
      ...
      eyebrow: "BACKGROUND · INFRASTRUCTURE",
      title: "THE STACK",
    ...
    cyberpunk: {
      ...
      sectionStyle: { position: "relative" },
      eyebrow: "// SYS_ARCHITECTURE.EXE",
      title: "STACK_/CORE",
      titleStyle: {
        fontFamily: "\"VT323\", monospace",
        color: "#00f0ff",
        letterSpacing: "0.04em",
        textShadow: "0 0 12px rgba(0,240,255,0.8), 0 0 30px rgba(0,240,255,0.4)",
      },
      eyebrowStyle: {
    ...
    holographic: {
      ...
      sectionStyle: { position: "relative" },
      eyebrow: "// IRIDESCENT INFRASTRUCTURE",
      ...
      bgDecor: (
        <>
          <div
            ...
            style={{ background: "radial-gradient(circle, rgba(160,20,90,0.35), transparent 70%)", filter: "blur(55px)" }}
          />
          <div
            className="absolute top-[50%] right-[8%] w-80 h-80 rounded-full orb-2 pointer-events-none"
            style={{ background: "radial-gradient(circle, rgba(0,70,130,0.35), transparent 70%)", filter: "blur(65px)" }}
          />
          <div
            className="absolute bottom-[5%] left-[40%] w-72 h-72 rounded-full orb-3 pointer-events-none"
            style={{ background: "radial-gradient(circle, rgba(80,20,140,0.35), transparent 70%)", filter: "blur(60px)" }}
          />
          <div
            className="absolute inset-0 pointer-events-none mix-blend-overlay opacity-25"
            style={{ backgroundImage: "url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='200' height='200'><filter id='n'><feTurbulence type='fractalNoise' baseFrequency='1.2' numOctaves='2'/></filter><rect width='100%25' height='100%25' filter='url(%23n)' opacity='0.6'/></svg>\")" }}
          />
        </>
      ),
    },
    ...
    refined: {
      ...
      bgDecor: (
        <>
          ...
          <div style={{
            position: "absolute", top: 0, left: 0, right: 0, height: 1,
            background: "linear-gradient(90deg, transparent, #b08a3e 20%, #b08a3e 80%, transparent)",
          }} />
          {/* very low opacity orbs */}
          <div className="refined-orb absolute pointer-events-none" style={{
            top: "20%", left: "10%", width: 300, height: 300,
            borderRadius: "50%",
            background: "radial-gradient(circle, rgba(176,138,62,0.06), transparent 70%)",
            filter: "blur(40px)",
          }} />
          <div className="refined-orb absolute pointer-events-none" style={{
            bottom: "15%", right: "12%", width: 250, height: 250,
            borderRadius: "50%",
    ...
    corporate: {
      ...
      bgDecor: (
        <>
          ...
          <div style={{
            position: "absolute", inset: 0, pointerEvents: "none",
            backgroundImage: "radial-gradient(circle, rgba(176,138,62,0.15) 1px, transparent 1px)",
    ...
    editorial: {
      ...
      sectionStyle: { position: "relative" },
      eyebrow: "★ Section IV · Infrastructure ★",
    ...
    organic: {
      ...
      sectionStyle: { position: "relative" },
      eyebrow: "✿ how it all grows together ✿",
      title: "the roots.",
      titleStyle: {
      ...
      bgDecor: (
        <>
          ...
          <div
            ...
            style={{
              top: "8%", left: "5%", width: 280, height: 280, borderRadius: "60% 40% 55% 45% / 50% 60% 40% 50%",
          ...
          <div
            ...
            style={{
              bottom: "10%", right: "8%", width: 240, height: 240, borderRadius: "45% 55% 40% 60% / 55% 45% 60% 40%",
              background: "radial-gradient(circle, rgba(107,58,91,0.18), transparent 70%)",
              filter: "blur(45px)",
            }}
          />
          <div
            className="blob-1 absolute pointer-events-none"
            style={{
              top: "45%", left: "50%", width: 200, height: 200, borderRadius: "50% 50% 40% 60% / 40% 60% 50% 50%",
              background: "radial-gradient(circle, rgba(80,107,61,0.15), transparent 70%)",
              filter: "blur(35px)",
              animationDelay: "7s",
            }}
          />
...
type MarkerKey = "player" | "auth" | "game" | "web" | "global" | "data" | "muted";
...
export default function ArchitectureDiagram({ theme }: { theme: ThemeId }) {
  ...
  const isDark = ["editorial", "refined", "corporate", "organic"].includes(theme);
  ...
  const box = (
    ...
    opts?: { sub?: string; w?: number; h?: number; godot?: boolean; stroke?: string }
  ) => (
    <Box
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {theme === "editorial" && (
          <div style={{
            height: 4, background: "#0c0c0c", marginBottom: 40,
          }} />
        )}
        {theme === "corporate" && (
          <div style={{
            height: 1,
            background: "linear-gradient(90deg, transparent, #b08a3e 30%, #b08a3e 70%, transparent)",
            marginBottom: 40,
          }} />
        )}
        ...
        <div style={{
          ...
          {skin.subtitle && (
            <div style={{
              ...
              color: theme === "corporate" ? "#b08a3e"
                : theme === "netflix" ? "#e50914"
                : "inherit",
      ...
      <div style={{
        ...
        <svg viewBox="0 0 1200 710" style={{ width: "100%", display: "block" }}>
          <defs>
            ...
            {(["player", "auth", "game", "web", "global", "data"] as const).map((k) => (
              <marker key={k} id={mid(k)}
            ...
            {!isDark && (
              <pattern id={`pts-${theme}`} width={24} height={24} patternUnits="userSpaceOnUse">
                <circle cx={0.5} cy={0.5} r={0.7} fill="rgba(255,255,255,0.04)" />
              </pattern>
            )}
          </defs>

          {/* SVG background */}
          <rect width={1200} height={710} fill={svgBgFill === "none" ? "transparent" : svgBgFill} />
          ...
          {[
            ...
            <rect key={i} x={84} y={b.y} width={1108} height={b.h} rx={8}
              fill={bandFill(b.c)} stroke={bandStroke(b.c)} strokeWidth={1} />
          ))}
          ...
          {[
            ...
            <line key={i} x1={x1} y1={y1} x2={x2} y2={y2}
              ...
              markerEnd={`url(#${mid("data")})`} opacity={0.28} />
          ))}

          {/* ── ARROW LABELS ── */}
          <ALbl x={755} y={192} text="ENet UDP" color={isDark ? `${C.player}88` : "rgba(255,255,255,0.28)"} />
          ...
          {/* ── BOXES ── */}
          {/* Player */}
          {box(220, 76, "Launcher", C.player, { sub: "Godot app", godot: true })}
          {box(650, 76, "Game Client", C.player, { sub: "Godot · ENet", w: 162, godot: true })}
          ...
          {box(490, 318, "MMO Central", C.game, { sub: ":4006", h: 58 })}
          {box(770, 318, "World Manager", C.game, { sub: ":4009", w: 162, h: 58 })}
          {box(1000, 318, "Game Server", C.game, { sub: "UDP:8000+", h: 58, godot: true })}
          {/* Web */}
          ...
          {/* ── BADGES ── */}
          {badge(705, 318, "JWT · 5 roles", C.auth)}
          {badge(1000, 280, "server meshing", C.game)}
          {badge(490, 395, "Grist pipeline", C.game)}
          {badge(920, 405, "idyllic-web.vercel.app", C.web)}
          ...
          <text x={1185} y={704} textAnchor="end"
            fill={isDark ? `${C.data}55` : "rgba(255,255,255,0.12)"} fontSize={8}

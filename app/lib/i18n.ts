...
export const PROJECT_ES: Record<string, { tagline: string; description: string }> = {
  ...
  "mercadolibre-electrodomesticos": {
    tagline: "Prototipo de afiliados, API MLC",
    description:
      "Prototipo de afiliados Next.js 15 para electrodomésticos en Chile. Pipeline SEO completo, JSON-LD, sitemap, integración OAuth de Mercado Libre.",
  },
  "car-shop-app": {
    tagline: "Prototipo POS + inventario para talleres",
    description:
      "Prototipo POS para talleres mecánicos. Ventas, inventario, clientes, vehículos y servicios. Transbank POS Integrado. Monorepo pnpm.",
  },
  inversionistas: {
    tagline: "Conecta inversores con proyectos — prototipo",
    description:
      "Prototipo web + PWA móvil. Bóveda de documentos, señales de interés, chat 1:1 tras aceptación. Pausado por configuración de almacenamiento.",
  },
  "boti-finder": {
    tagline: "Descubre botillerías con promos — prototipo",
    description:
      "Prototipo de descubrimiento de botillerías y minimarkets en mapa. Google Places API (New). Pausado por billing de GCP.",
  },
  "free-pickup": {
    tagline: "Regala objetos localmente — prototipo",
    description:
      "Prototipo de intercambio geolocalizados de objetos gratis. Better Auth, Drizzle ORM, Neon. Multi-tenant con schema aislado.",
  },
  github: {
